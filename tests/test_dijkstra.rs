...
fn test_dijkstra_plan0() {
  ...
  builder::plot_gridmap(&gridmap, &start_cell, &goal_cell, &motion_plan, "test_maps/planners/dijkstra/test_plan0.png");
...
fn test_dijkstra_plan3() {
  ...
  builder::plot_gridmap(&gridmap, &start_cell, &goal_cell, &motion_plan, "test_maps/planners/dijkstra/test_plan3.png");
...
fn test_dijkstra_plan4() {
  ...
  builder::plot_gridmap(&gridmap, &start_cell, &goal_cell, &motion_plan, "test_maps/planners/dijkstra/test_plan4.png");
